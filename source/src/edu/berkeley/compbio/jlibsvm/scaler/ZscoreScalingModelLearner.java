...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    public ZscoreScalingModelLearner() {
...
// ------------------------ INTERFACE METHODS ------------------------
    ...
    public byte[] serialize() {
        BinaryBuffer buffer = new BinaryBuffer(5);

        buffer.append(this.maxExamples);
        buffer.append(this.normalizeL2);
    ...
    public void load(byte[] data) {
        ...
        this.maxExamples = buffer.readInt();
        this.normalizeL2 = buffer.readBoolean();
    }
